...
register("chat", (msg) => {
    if (!Config.bigSpecial300Message) return;
    ...
    if (lowerCaseFullMessage.includes(`300 score`) && fullMessage.indexOf(playerName) == -1 && fullMessage.includes("Party") && fullMessage.indexOf(":") != -1) { //detecting score message and making sure it's not sent by the user itself(to prevent spam and also it's weird) and making sure it's only in party chat //making sure it's send by a player
        ChatLib.command(`pc ゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜ ゛゜゛████゜████゛████゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛ ゜゛゜゛゜゛█゛█゛゜█゜█゜゛█゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜ ゛゜゛████゜█゜゛█゛█゛゛█゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛ ゜゛゜゛゜゛█゛█゛゜█゜█゜゛█゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜ ゛゜゛████゜████゛████゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛ ゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜゛゜`)
    }     
})